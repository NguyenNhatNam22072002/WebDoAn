...
<body>
	...
	<nav class="row">
		<nav class="col navbar navbar-expand-sm navbar-light bg-light">
			<a class="navbar-brand" href="#">UTE</a>
			...
			<div class="collapse navbar-collapse" id="collapsibleNavId">
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					<li class="nav-item active"><a class="nav-link" href="Homepage">
							<i class="fa fa-home" aria-hidden="true">Home</i> <span
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="dropdownId">
							...
							<c:if test="${isLogin}">
								...
								<a class="dropdown-item" href="EditProfile">Edit Profiles</a>
							</c:if>
						</div>
					</li>
				</ul>
	...
	<footer class="row">
		<div class="col text-center border-top">
			<strong>UTE poly &copy; All rights reserved</strong>
		</div>
	</footer> </main>
	<!-- Optional JavaScript -->
